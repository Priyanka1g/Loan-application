  ...
  return (
    <div>
        <div className="container" >
            <h1 style={{textAlign:"center", margin:"20px",fontFamily:"lato",color:"white"}}>User Info</h1>
            ...
            <button style={{marginRight:"20px"}}type="button" class="btn btn-dark">Accept</button>
